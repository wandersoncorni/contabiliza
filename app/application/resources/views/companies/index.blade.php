    ...
    <div class="col-md-12">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                <h2 class="h4 d-flex">
                    <i class="heroicon heroicon-users me-2" style="width: 24px;height: 24px;"></i> Empresas
                </h2>
            </div>
...
<div class="modal fade" id="modal-form-company" tabindex="-1" role="dialog" aria-labelledby="modal-form-company" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-company" method="POST" action="POST" enctype="multipart/form-data">
                    <div class="mb-3">
