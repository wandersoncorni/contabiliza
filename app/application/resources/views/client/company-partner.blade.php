                ...
                <form id="form-partner" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-12 col-md-12 bg-gray-100 rounded-lg shadow p-4 mb-3">
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <label class="form-label">Responsável perante a Receita Federal</label>
                                <div class="p-1">
                                    <label for="resp_rf_0" class="form-label me-5">Não <input type="radio" class="form-check-input" id="resp_rf_0" name="resp_rf" required></label>
                                    <label for="resp_rf_1" class="form-label">Sim <input type="radio" class="form-check-input" id="resp_rf_1" name="resp_rf" required></label>
                                </div>
                            </div>
                        </div>
                    </div>
