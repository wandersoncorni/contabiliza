...
<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
    <a class="navbar-brand me-lg-5" href="../../index.html">
        <img class="navbar-brand-dark" src="/img/logo2.png" alt="ContabilizaTech" />
        <img class="navbar-brand-light" src="/img/logo2.png" alt="ContabilizaTech" />
    </a>
        ...
        <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
            <div class="d-flex align-items-center">
                <div class="avatar-lg me-4">
                    <img src="{{Auth::user()->photo ?? '/img/default-profile.png'}}" class="card-img-top rounded-circle border-white" alt="Bonnie Green">
                </div>
                <div class="d-block">
                ...
                <ul class="navbar-nav align-items-center">
                    <li>
                        <a class="nav-link" href="#" role="button">
                            <svg class="icon icon-sm text-gray-900" aria-hidden="true" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-bottom">
                                    <div class="row align-items-center">
                                        <div class="col-auto">
                                            <!-- Avatar -->
                                            <img alt="Image placeholder" src="{{Auth::user()->photo ?? '/img/default-profile.png'}}" class="avatar-md rounded">
                                        </div>
                    ...
                    <li class="nav-item dropdown ms-lg-3">
                        <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <div class="media d-flex align-items-center">
                                <img class="avatar rounded-circle" alt="Image placeholder" src="{{Auth::user()->photo ?? '/img/default-profile.png'}}">
